...
object GameData {
  ...
  def init(forTesting: Boolean = false) {
    ...
    val game21 = Game(21, colombia.reference, ivoryCoast.reference, june(19,13,00), brasilia)
    ...
    val game24 = Game(24, italy.reference, costaRica.reference, june(20,13,00), recife)
